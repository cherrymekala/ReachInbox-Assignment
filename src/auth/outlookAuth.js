...
const outlookClient = microsoft_graph_client_1.Client.initWithMiddleware({
    authProvider: {
        getAccessToken: () => __awaiter(void 0, void 0, void 0, function* () {
            const tokenResponse = yield credential.getToken(['Mail.ReadWrite', 'Mail.Send']);
            return tokenResponse === null || tokenResponse === void 0 ? void 0 : tokenResponse.token;
        }),
    },
});
exports.default = outlookClient;
